...
function showInfo(event) {
  ...
  getjson(url, function(obj) {
    for (key in obj) {
      ...
      if (event === key) {
        // template info
        var data = '<h3>' + obj[key].date + '</h3>' +
            '<dl>' +
            '<dt><dfn>Workout:</dfn></dt><dd>' + obj[key].workoutType + '</dd>' +
            '<dt><dfn>Exersice:</dfn></dt><dd>' + obj[key].excersise1 + '</dd>' +
            '<dt><dfn>Reps:</dfn></dt><dd>' + obj[key].reps1 + '</dd>' +
            '<dt><dfn>Sets:</dfn></dt><dd>' + obj[key].sets1 + '</dd>' + 
            '<dt><dfn>Exersise:</dfn></dt><dd>' + obj[key].excersise2 + '</dd>' +
            '<dt><dfn>Reps:</dfn></dt><dd>' + obj[key].reps2 + '</dd>' +
            '<dt><dfn>Sets:</dfn></dt><dd>' + obj[key].sets2 + '</dd>' +
            '</dl>';
